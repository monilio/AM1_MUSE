from numpy import array, zeros, linspace, log, polyfit
...
def plot_logs(F, U0, t1, temporal_scheme, N_ini, N_refinements=6, **kwargs):

    log_N, log_E = convergence_rate(F, U0, t1, temporal_scheme, N_ini, tol_J=1e-9, max_iter=10000, tol_N=1e-9)
...
plot_logs(F, U0, t1, Euler, 20000)
plot_logs(F, U0, t1, RK4, 500)
plot_logs(F, U0, t1, Crank_Nicolson, 100)
plot_logs(F, U0, t1, Evil_Euler, 200)